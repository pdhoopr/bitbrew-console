...
import { CheckboxIcon, CheckboxOutlineIcon, RadioButtonIcon } from './Icons';
...
const ControlLabel = styled(Label)`
  ...
  ${/* sc-selector */ CheckboxOutlineIcon},
    ...
    <React.Fragment>
      ...
      <ControlLabel htmlFor="enabled">
        ...
        {form.enabled ? (
          ...
          <CheckboxOutlineIcon aria-hidden />
        )}
        Enabled
      </ControlLabel>
    </React.Fragment>
...
export default observer(DeviceFields);
